...
source("CJ_Upselling/CJ_UP_Utils.R")





base_attivi <- read.df("/user/stefano.mazzucca/attivi_codici_out_upgr.csv", source = "csv", header = "true", delimiter = ",")
...
write.parquet(base_up, "/user/stefano.mazzucca/cj_up_prj_marketing/base_up.parquet")


base_up <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/base_up.parquet")
View(head(base_up,100))
nrow(base_up)
# 604.424

valdist_extid_dat <- distinct(select(base_up, "COD_CLIENTE_CIFRATO", "DAT_EVENTO"))
nrow(valdist_extid_dat)
# 603.946
valdist_codcntr_dat <- distinct(select(base_up, "COD_CONTRATTO", "DAT_EVENTO"))
...
ext_id <- distinct(select(base_up, "COD_CLIENTE_CIFRATO"))
nrow(ext_id)
# 530.696
...
write.parquet(diz_ext_id_coo,"/user/stefano.mazzucca/cj_up_prj_marketing/chiavi_coo.parquet")


chiavi_coo <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/chiavi_coo.parquet")
View(head(chiavi_coo,100))
nrow(chiavi_coo)
# 3.795.980


## join tra base_up e chiavi_cookie

createOrReplaceTempView(base_up, "base_up")
createOrReplaceTempView(chiavi_coo, "chiavi_coo")

base_up_coo <- sql("select distinct t1.*, t2.post_visid_concatenated
                           from base_up t1
                           inner join chiavi_coo t2
                           on t1.COD_CLIENTE_CIFRATO = t2.external_id_post_evar")
# View(head(base_up_coo,100))
# nrow(base_up_coo)
# 

write.parquet(base_up_coo,"/user/stefano.mazzucca/cj_up_prj_marketing/base_up_coo.parquet")


base_up_coo <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/base_up_coo.parquet")
View(head(base_up_coo,100))
nrow(base_up_coo)
# 4.395.872
...
createOrReplaceTempView(base_up_coo,"base_up_coo")
...
write.parquet(nav_sez_corporate,"/user/stefano.mazzucca/cj_up_prj_marketing/scarico_nav_corporate.parquet")

nav_sez_corporate <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/scarico_nav_corporate.parquet")
...
# 448.401 (vs. 603.946 dai dati di input --> 155.545 "coppiette" perse) N.B. Verificare se le troviamo in WSC/APP
...
# 40.942.512 (vs. 66.561.128 di scarico totale --> elimino 25.618.616 records di hit "too short")
...
write.parquet(nav_sez_corporate_4, "/user/stefano.mazzucca/cj_up_prj_marketing/nav_corporate_filt.parquet")


nav_sez_corporate_4 <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/nav_corporate_filt.parquet")
View(head(nav_sez_corporate_4,100))
nrow(nav_sez_corporate_4)
# 12.140.782 (vs. 40.942.512 di scarico filtrato ai 10 sec di navigazione --> 28.801.730 records di navigazione eliminati perche' fuori dai 3 mesi di interesse)
...
write.parquet(navigazione_2, "/user/stefano.mazzucca/cj_up_prj_marketing/navigazione_desktop.parquet")
...
write.parquet(nav_app_wsc,"/user/stefano.mazzucca/cj_up_prj_marketing/scarico_nav_app_wsc.parquet")


nav_app_wsc <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/scarico_nav_app_wsc.parquet")
...
nrow(valdist_extid_dat_)
# 277.750 (vs. 603.946 dai dati di input --> 326.196 "coppiette" perse) N.B. Verificare se le troviamo in Sito Desktop



nav_app_wsc_1 <- remove_too_short(nav_app_wsc, 4)
View(head(nav_app_wsc_1,100))
nrow(nav_app_wsc_1)
# 30.447.254 (vs. 865.615.838 di scarico totale --> elimino 835.168.584 records di hit "too short")
...
write.parquet(nav_app_wsc_4, "/user/stefano.mazzucca/cj_up_prj_marketing/nav_app_wsc_filt.parquet")


nav_app_wsc_4 <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/nav_app_wsc_filt.parquet")
View(head(nav_app_wsc_4,100))
nrow(nav_app_wsc_4)
# 9.073.760 (vs. 30.447.254 di scarico filtrato ai 4 sec di navigazione --> 21.373.494 records di navigazione eliminati perche' fuori dai 3 mesi di interesse)
...
write.parquet(navigazione_4, "/user/stefano.mazzucca/cj_up_prj_marketing/navigazione_app.parquet")


## Unisco le navigazioni desktop e app ##########################################################################################################################

nav_desktop <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/navigazione_desktop.parquet")
...
nav_app <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/navigazione_app.parquet")
...
View(head(navigazioni_target_1,1000))
...
# 322.145 (vs. 604.424 iniziali)


write.parquet(navigazioni_target_1, "/user/stefano.mazzucca/cj_up_prj_marketing/navigazione_hit_target.parquet")



## Navigazioni raggruppate per visite ##########################################################################################################################

navigazioni_target <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/navigazione_hit_target.parquet")
...
write.parquet(navigazioni_visits_target_1, "/user/stefano.mazzucca/cj_up_prj_marketing/navigazione_visit_target.parquet")
...
write.parquet(dem_sms_click_3, "/user/stefano.mazzucca/cj_up_prj_marketing/dem_sms_click_target.parquet")
...
write.parquet(cookieid_skyid_adform, "/user/stefano.mazzucca/cj_up_prj_marketing/chiavi_coo_adform.parquet")


## Aggancio skyid al cookie su tutti i convertenti ###################################################################


cookieid_skyid_adform <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/chiavi_coo_adform.parquet")
...
base_up_coo_adform <- sql("select t1.*, t2.cookieid , t2.`device-name` , t2.`os-name` , t2.`browser-name`
                                  from base_up t1
                                  left join cookieid_skyid_adform t2
                                  on t1.COD_CLIENTE_CIFRATO = t2.skyid")


write.parquet(base_up_coo_adform, "/user/stefano.mazzucca/cj_up_prj_marketing/base_up_coo_adform.parquet")


base_up_coo_adform <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/base_up_coo_adform.parquet")
View(head(base_up_coo_adform,100))
nrow(base_up_coo_adform)
# 12.183.017
...
createOrReplaceTempView(base_up_coo_adform,"base_up_coo_adform")
...
click_adform_target <- sql("SELECT t1.*, 
                           ...
                           t2.date_time_ts,
                           t2.`campaign-name`
                           FROM base_up_coo_adform t1
                           INNER JOIN click_7 t2
                           ON t1.cookieid = t2.cookieid")
# first(flg_app_wsc) as flg_app_wsc

write.parquet(click_adform_target,"/user/stefano.mazzucca/cj_up_prj_marketing/scarico_click_adform.parquet")


click_adform_target <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/scarico_click_adform.parquet")
...
nrow(valdist_extid_dat_)
# 348.904 (vs. 603.946 dai dati di input --> 255.042 "coppiette" perse) 
...
# nrow(valdist_extid_dat_)
#  (vs. 603.946 dai dati di input --> ? "coppiette" perse) 
...
write.parquet(click_adform_target_6, "/user/stefano.mazzucca/cj_up_prj_marketing/click_adv_target.parquet")
...
write.parquet(impression_adform_target,"/user/stefano.mazzucca/cj_up_prj_marketing/scarico_impression_adform.parquet")


impression_adform_target <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/scarico_impression_adform.parquet")
...
nrow(valdist_extid_dat_)
# 473.310 (vs. 603.946 dai dati di input --> 130.636 "coppiette" perse) 
...
write.parquet(impression_adform_target_6, "/user/stefano.mazzucca/cj_up_prj_marketing/impression_adv_target.parquet")
...
nav_visite_target <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/navigazione_visit_target.parquet")
...
dem_sms_click <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/dem_sms_click_target.parquet")
...
adv_click <- read.parquet("/user/stefano.mazzucca/cj_up_prj_marketing/click_adv_target.parquet")
...
write.parquet(lista_eventi_digital_target_upselling_1, "/user/stefano.mazzucca/cj_up_prj_marketing/lista_eventi_digital.parquet")
...
write.df(repartition( lista_eventi_digital, 1), path = "/user/stefano.mazzucca/cj_up_prj_marketing/lista_eventi_digital.csv", "csv", sep=";", mode = "overwrite", header=TRUE)

...
path_kpi_sito <- "/user/stefano.mazzucca/prova_mappatura/kpi_sito.parquet"
path_kpi_app <- "/user/stefano.mazzucca/prova_mappatura/kpi_app.parquet"
path_kpi_finale <- "/user/stefano.mazzucca/prova_mappatura/kpi_finale.parquet"

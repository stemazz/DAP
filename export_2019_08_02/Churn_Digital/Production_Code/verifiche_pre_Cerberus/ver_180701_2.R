...
path_cb <- "/user/stefano.mazzucca/churn_digital_ver/1807.csv"
path_lista_output <- "/user/stefano.mazzucca/churn_digital_ver/output_modello_CD_180701_2.csv"

# path_ver <- "/user/stefano.mazzucca/churn_digital_ver/ver_180701_2.csv"
path_ver_csv <- "/user/stefano.mazzucca/churn_digital_ver/ver_csv_180701_2.csv"
path_csv1 <- "/user/stefano.mazzucca/churn_digital_ver/csv_pdisc_180701._2csv"

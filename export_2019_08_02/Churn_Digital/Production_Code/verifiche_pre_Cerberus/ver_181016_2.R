...
# path_ver <- "/user/stefano.mazzucca/churn_digital_ver/ver_181016_2.csv"
path_ver_csv <- "/user/stefano.mazzucca/churn_digital_ver/ver_csv_181016_2.csv"
path_csv1 <- "/user/stefano.mazzucca/churn_digital_ver/csv_pdisc_181016_2.csv"

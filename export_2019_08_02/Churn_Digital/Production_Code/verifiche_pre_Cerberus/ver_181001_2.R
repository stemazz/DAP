...
path_cb <- "/user/stefano.mazzucca/churn_digital_ver/1810.csv"
path_lista_output <- "/user/stefano.mazzucca/churn_digital_ver/output_modello_CD_181001_2.csv"

# path_ver <- "/user/stefano.mazzucca/churn_digital_ver/ver_181001_2.csv"
path_ver_csv <- "/user/stefano.mazzucca/churn_digital_ver/ver_csv_181001_2.csv"
path_csv1 <- "/user/stefano.mazzucca/churn_digital_ver/csv_pdisc_181001._2csv"

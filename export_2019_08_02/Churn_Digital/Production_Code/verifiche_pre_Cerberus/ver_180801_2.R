...
path_cb <- "/user/stefano.mazzucca/churn_digital_ver/1808.csv"
path_lista_output <- "/user/stefano.mazzucca/churn_digital_ver/output_modello_CD_180801_2.csv"

# path_ver <- "/user/stefano.mazzucca/churn_digital_ver/ver_180801_2.csv"
path_ver_csv <- "/user/stefano.mazzucca/churn_digital_ver/ver_csv_180801_2.csv"
path_csv1 <- "/user/stefano.mazzucca/churn_digital_ver/csv_pdisc_180801._2csv"

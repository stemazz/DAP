...
clienti_nopdisc_17 <- read.parquet("/user/valentina/ModChurnOnLine_base_NO_Pdisc.parquet")
...
clienti_nopdisc_17 <- withColumnRenamed(clienti_nopdisc_17, "FASCIA_SDM_PDISC_M1_05", "meno1M_FASCIA_SDM_PDISC_M1")
clienti_nopdisc_17 <- withColumnRenamed(clienti_nopdisc_17, "FASCIA_SDM_PDISC_M4_05", "meno1M_FASCIA_SDM_PDISC_M4")
...
# IMPORTO COOKIE SITO -----------------------------------------------------
#cookie_sito_nopdisc_17 <- read.parquet("/user/riccardo.motta/churn_digital/skyitdev_nopdisc.parquet") ###### CAMBIO QUI! #####################################
cookie_sito_nopdisc_17 <- read.parquet("/user/valentina/churnOnline_rifaiMod_scarico_navigaz_NoPdisc_trainingModello.parquet") 
...
#write.parquet(df_kpi_sito_nopdisc_17, "/user/riccardo.motta/churn_digital/kpi_luglio_18/df_kpi_sito_nopdisc_17.parquet") #### SALVO IN ALTRO PATH !!!!
#write.parquet(df_kpi_sito_nopdisc_17, "/user/riccardo.motta/churn_digital/kpi_luglio_18/df_kpi_sito_nopdisc_17_bis.parquet")
write.parquet(df_kpi_sito_nopdisc_17, "/user/stefano.mazzucca/churn_digital/df_kpi_sito_nopdisc_17.parquet", mode = "overwrite")


# IMPORTO COOKIE APP ------------------------------------------------------
cookie_app_nopdisc_17 <- read.parquet("/user/riccardo.motta/churn_digital/skyappwsc_nopdisc.parquet")
...
#write.parquet(df_kpi_app_nopdisc_17, "/user/riccardo.motta/churn_digital/kpi_luglio_18/df_kpi_app_nopdisc_17.parquet")
#write.parquet(df_kpi_app_nopdisc_17, "/user/riccardo.motta/churn_digital/kpi_luglio_18/df_kpi_app_nopdisc_17_bis.parquet")
write.parquet(df_kpi_app_nopdisc_17, "/user/stefano.mazzucca/churn_digital/df_kpi_app_nopdisc_17.parquet", mode = "overwrite")


# MERGE KPI ---------------------------------------------------------------

#df_kpi_sito_nopdisc_17 <- read.parquet("/user/riccardo.motta/churn_digital/kpi_luglio_18/df_kpi_sito_nopdisc_17_bis.parquet")
df_kpi_sito_nopdisc_17 <- read.parquet("/user/stefano.mazzucca/churn_digital/df_kpi_sito_nopdisc_17.parquet")
#df_kpi_app_nopdisc_17 <- read.parquet("/user/riccardo.motta/churn_digital/kpi_luglio_18/df_kpi_app_nopdisc_17_bis.parquet")
df_kpi_app_nopdisc_17 <- read.parquet("/user/stefano.mazzucca/churn_digital/df_kpi_app_nopdisc_17.parquet")
...
#write.parquet(df_kpi_nopdisc_17, "/user/riccardo.motta/churn_digital/kpi_luglio_18/df_kpi_nopdisc_17.parquet") ## CAMBIO PER NON SOVRASCRIVERE !!!!
#write.parquet(df_kpi_nopdisc_17, "/user/riccardo.motta/churn_digital/kpi_luglio_18/df_kpi_nopdisc_17_bis.parquet")
write.parquet(df_kpi_nopdisc_17, "/user/stefano.mazzucca/churn_digital/df_kpi_nopdisc_17.parquet", mode = "overwrite")

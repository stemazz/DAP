## Setting (SI) PDISC per validazione modello
source("Churn_Digital/00_Utils.R")


# IMPORT CLIENTI + INFO BASE ----------------------------------------------
clienti_pdisc_17 <- read.parquet("/user/valentina/churnOnline_scaricoBI_xtest_Pdisc.parquet")
...
cookie_sito_pdisc_17 <- read.parquet("/user/valentina/churnOnline_scaricoBI_xtest_navigazSkyITDev_OK.parquet") #### CAMBIO QUI !!! #################
...
id_clienti_pdisc_17 <- withColumnRenamed(id_clienti_pdisc_17, "COD_CLIENTE_CIFRATO", "COD_CLIENTE_CIFRATO_y")
...
cookie_sito_pdisc_17 <- drop(cookie_sito_pdisc_17, "COD_CLIENTE_CIFRATO_y")

# INSERISCO VARIABILI DI PARTENZA -----------------------------------------
cookie_sito_pdisc_17 <- join_COD_CLIENTE_CIFRATO(cookie_sito_pdisc_17, clienti_pdisc_17)
cookie_sito_pdisc_17 <- withColumnRenamed(cookie_sito_pdisc_17, "INGR_PDISC_dt_x", "TARGET_dt")

# ID UNIVOCI --------------------------------------------------------------
id_clienti_pdisc_17 <- withColumnRenamed(id_clienti_pdisc_17, "COD_CLIENTE_CIFRATO_y", "COD_CLIENTE_CIFRATO")
...
write.parquet(df_kpi_sito_pdisc_17, "/user/stefano.mazzucca/new_CJ_PDISC_df_kpi_sito_pdisc_18.parquet") #### SALVO IN ALTRO PATH !!!!


# IMPORTO COOKIE APP ------------------------------------------------------
cookie_app_pdisc_17 <- read.parquet("/user/valentina/churnOnline_scaricoBI_xtest_navigazAPP.parquet") ## CAMBIO QUI
...
cookie_app_pdisc_17 <- withColumnRenamed(cookie_app_pdisc_17, "INGR_PDISC_dt_y", "TARGET_dt")
...
write.parquet(df_kpi_app_pdisc_17, "/user/stefano.mazzucca/new_CJ_PDISC_df_kpi_app_pdisc_18.parquet")

# MERGE KPI ---------------------------------------------------------------

df_kpi_sito_nopdisc_17 <- read.parquet("/user/stefano.mazzucca/new_CJ_PDISC_df_kpi_sito_pdisc_18.parquet") ## CAMBIO DI PATH !!
df_kpi_app_nopdisc_17 <- read.parquet("/user/stefano.mazzucca/new_CJ_PDISC_df_kpi_app_pdisc_18.parquet") ## CAMBIO DI PATH !!
...
write.parquet(df_kpi_nopdisc_17, "/user/stefano.mazzucca/new_CJ_PDISC_df_kpi_pdisc_18.parquet")

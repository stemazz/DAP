...
df_corretto <- read.parquet(path_df_corretto)

df_variabile_24 <- df_corretto 
...
df_variabile_25 = fillna(df_variabile_24, 0)
#View(head(df_variabile_25,100))

write.parquet(df_variabile_25,path_df_variabile_25)

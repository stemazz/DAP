...
data_inizio= as.Date('2018-01-01')
data_fine=as.Date('2018-06-30')

data_inizio_diz <- as.Date('20180101')
data_fine_diz <- as.Date('20181231')

path_impression= '/STAGE/adform/table=Impression'

path_tp <- "/STAGE/adform/table=Trackingpoint/Trackingpoint.parquet"

path_scarico_impression_genn_giu_2018 = "/user/emma.cambieri/impression_20180101_20180630.parquet"

path_dizionario_adform = "/user/matteo.ballerinipuviani/dizionario_adform_20190213.parquet"

path_impression_con_diz_20180101_20180630 = "/user/emma.cambieri/impression_con_diz_20180101_20180630.parquet"

path_impression_variabile0_genn_giu = "/user/emma.cambieri/impression_variabili0_20180101_20180630.parquet"

path_impression_variabili1 = "/user/emma.cambieri/impression_variabili1_20180101_20180630.parquet"

path_impression_variabili2 = "/user/emma.cambieri/impression_variabili2_20180101_20180630.parquet"

path_impression_variabili3 = "/user/emma.cambieri/impression_variabili3_20180101_20180630.parquet"

path_impression_variabili4 = "/user/emma.cambieri/impression_variabili4_20180101_20180630.parquet"

path_impression_con_diz_20180101_20180630 = "/user/emma.cambieri/impression_con_diz_20180101_20180630.parquet"

path_impression_social = "/user/emma.cambieri/impression_social_20180101_20180630.parquet"

path_impression_join_finale = "/user/emma.cambieri/impression_join_finale_20180101_20180630.parquet"




impression= read.parquet(path_impression)
printSchema(impression)
...
write.parquet(impression4, path_scarico_impression_genn_giu_2018)

# prova= filter(impression2, impression2$CookieID == '-1192254912370337280' & impression2$Timestamp=='2018-09-18')
# View(head(prova,100))


# Join con dizionario:

impression_df= read.parquet(path_scarico_impression_genn_giu_2018)
# nrow(impression_df) #3.907.663.756
# View(head(impression_df,100))
...
adform2 <- filter(adform, adform$yyyymmdd >= data_inizio_diz)
adform3 <- filter(adform2, adform2$yyyymmdd <= data_fine_diz)
...
write.parquet(join1, path_impression_con_diz_20180101_20180630) #,mode='overwrite')


################## CREAZIONE VARIABILI ################## 

impression_df= read.parquet(path_impression_con_diz_20180101_20180630)
...
write.parquet(imp_df0, path_impression_variabile0_genn_giu) #, mode='overwrite')

...
secondi_appwsc <- remove_too_short(appwsc_new3, 5) 
...
secondi_appgtv <- remove_too_short(appgtv_new3, 5) 
...
secondi_appsport <- remove_too_short(appsport_new3, 5) 
...
secondi_appxfactor <- remove_too_short(appxfactor_new3, 5) 

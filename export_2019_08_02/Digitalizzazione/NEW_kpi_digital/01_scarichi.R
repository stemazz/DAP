...
diz_7 <- read.parquet(path_diz_skyitdev_2)
...
diz_8 <- withColumnRenamed(diz_7, "external_id_post_evar", "skyid")
diz_9 <- withColumnRenamed(diz_8, "post_visid_concatenated", "cookie")

skyitdev_diz <- join(skyit_5, diz_9, skyit_5$post_visid_concatenated==diz_9$cookie, "left")
